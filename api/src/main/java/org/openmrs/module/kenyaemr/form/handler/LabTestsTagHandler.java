...
import org.openmrs.module.kenyaemr.form.element.LabTestsSubmissionElement;
 ...
 *
 */
public class LabTestsTagHandler extends SubstitutionTagHandler {
	...
	protected String getSubstitution(FormEntrySession session, FormSubmissionController submissionController, Map<String, String> parameters) throws BadFormDesignException {
		LabTestsSubmissionElement element = new LabTestsSubmissionElement(session.getContext(), parameters);
