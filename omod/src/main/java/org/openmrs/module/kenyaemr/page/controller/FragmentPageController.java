...
/**
 * A page containing a single fragment
 */
public class FragmentPageController {
	...
	public void controller(HttpServletRequest request, Map<String, Object> model) throws PageAction {
		String fragmentProvider = (String) request.getAttribute("fragmentProvider");
		String fragment = (String) request.getAttribute("fragment");

		if (fragmentProvider == null || fragment == null) {
			throw new RuntimeException("Fragment page requires a 'fragment' parameter");

		}

		model.put("fragmentProvider", fragmentProvider);
